...
export const CoinMarketSchema = z.object({
  ...
  // CoinGecko can return null for 24h stats when data is missing (e.g. new or illiquid coins)
  high_24h: z.number().nullable().transform((v) => v ?? 0),
  low_24h: z.number().nullable().transform((v) => v ?? 0),
  price_change_24h: z.number().nullable().transform((v) => v ?? 0),
  price_change_percentage_24h: z.number().nullable(),
  market_cap_change_24h: z.number().nullable().transform((v) => v ?? 0),
  market_cap_change_percentage_24h: z.number().nullable().transform((v) => v ?? 0),
